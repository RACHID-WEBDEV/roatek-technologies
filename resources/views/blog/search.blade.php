				...
				<section id="breadcrumb_section" class="breadcrumb_section bg_gradient_blue deco_wrap d-flex align-items-center text-white clearfix">
					<div class="container">
						<div class="breadcrumb_content text-center" data-aos="fade-up" data-aos-delay="100">
							<h1 class="page_title">Search Result: {{$query}}</h1>
									...
									<div class="col-lg-6 col-md-6 col-sm-6">
										<div class="blog_grid decrease_size" data-aos="fade-up" data-aos-delay="300">
											...
											<div class="item_content">
												...
												<p class="mb-30">
                                                    {!! \Illuminate\Support\Str::limit($post->body, 130, "...")!!}												</p>
												<div class="row">
													<div class="col-6">
														<a href="/blog/{{$post->slug}}" class="details_btn">Read More <i class="fal fa-long-arrow-right"></i></a>
													</div>
													<div class="col-6">
										...
										<ul class="clearfix">
											...
											<li>
												<div class="blog_small">
													...
													<div class="item_content">
														<h4 class="item_title">
															<a href="{{$postt->slug}}">{{$postt->title}}</a>
														</h4>
